...
Date: 21 Jan 2021
Objective: Output the Figure 5 in the paper with similar style
*/
...
// Figure 1 //
/* need to set the style recording that is the command play(porter_serra_4) 
and play(porter_serra_5)
...
graph export "figures_tables\figure5.pdf", as(pdf) name("Graph") replace