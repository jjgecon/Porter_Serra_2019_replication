...
Date: 21 Jan 2021
Objective: Output a LaTeX table similar to Table 3 in the paper
*/
...
forvalues i = 1/4 {
    ...
    reg took_year $interest if female==1, cluster(class_fe2)
    ...
    reg took_year $interest $controls if female==1, cluster(class_fe2)
    ...
    reg tookanother $interest if female==1, cluster(class_fe2)
...
texdoc init "figures_tables\table3.tex", replace force
tex \begin{tabular}{lcccc} \toprule 
tex  & Took Micro & Took Micro & Took another & Took another\tabularnewline
tex  & within year  & within year  & econ class  & econ class \tabularnewline
tex \midrule &  &  &  & \tabularnewline
