...
forvalues i = 1/4 {
    ...
    reg Major_SocSc $interest $controls if female==1, cluster(class_fe2)
    ...
    reg Major_Arts $interest $controls if female==1, cluster(class_fe2)
    ...
    reg Major_Comm $interest $controls if female==1, cluster(class_fe2)
    ...
    reg Major_Hum $interest $controls if female==1, cluster(class_fe2)
...
texdoc init "figures_tables\table6.tex", replace force
tex \begin{tabular}{lcccc} \toprule 
tex  & Major &  & Major & \tabularnewline 
tex  & social sciences & Major arts & communication & Major humanities \tabularnewline \midrule
tex  &  &  &  & \tabularnewline
