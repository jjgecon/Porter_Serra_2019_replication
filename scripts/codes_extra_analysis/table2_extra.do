...
forvalues i = 1/8 {
    ...
    reg took_fall $interest $controls if female == 0, cluster(class_fe2)
    ...
    reg econmajor $interest $controls if female == 0, cluster(class_fe2)
    ...
    reg numeconclass $interest $controls if female == 0, cluster(class_fe2)
    ...
    reg tookanother $interest $controls if female == 0, cluster(class_fe2)
...
texdoc init "figures_tables\table2_extra.tex", replace force
